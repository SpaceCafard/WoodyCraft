...
<div class="container">
    ...
    <center>
        <form action="{{ route('admin.storeCat') }}" enctype="multipart/form-data" method="POST" class="form">

            @csrf
            <span class="signup">Ajouter une catégorie</span>
            @if ($errors->has('name'))
                <span class="text-danger">Vous devez entrer un nom pour votre catégorie</span>
            @endif
            <input type="text" placeholder="Nom de la Categorie" name="name" class="form--input">
