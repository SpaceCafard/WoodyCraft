...
<div class="container">
    <h1>Catégorie Active</h1>
    <a class="btn btn-primary" href="{{ route('admin.createCat') }}">Ajouter une categorie</a>

    @foreach ($categories as $categorie)
        @if($categorie->status == 0)

            <div class="product">
                <div class="name">{{ $categorie->name }}</div>
                <a class="btn btn-warning" href="{{ route('admin.editCat', $categorie->id) }}">Modifier</a><p>ㅤ</p>
